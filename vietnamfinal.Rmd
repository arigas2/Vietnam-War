...
![NW of Saigon, March 1965. Horst Faas/AP](helicopters.jpg)
...
```{r, echo = FALSE}
knitr::include_graphics("1965.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1966.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1967.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1968.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1969.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1970.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1971.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1972.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("1973.png")
```
...
![B-52 dropping payload during the Christmas Bombing, December 1972. USAF.](b52.jpg)
...
![Hanoi's Kham Thien Street, devastated by the Christmas Bombings, December 1972.](xmas.jpg)
